...
vim.api.nvim_create_user_command("SigilBenchmark", function()
  local benchmark = require("sigil.benchmark")
  local results = benchmark.run_suite()
  benchmark.print_results(results)
end, { desc = "Run sigil performance benchmark" })
